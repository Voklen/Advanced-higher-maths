...
class RustBackendImpl implements RustBackend {
  final RustBackendPlatform _platform;
  factory RustBackendImpl(ExternalLibrary dylib) =>
      RustBackendImpl.raw(RustBackendPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory RustBackendImpl.wasm(FutureOr<WasmModule> module) =>
      RustBackendImpl(module as ExternalLibrary);
  RustBackendImpl.raw(this._platform);
  Future<int> square({required int n, dynamic hint}) {
    var arg0 = api2wire_u32(n);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_square(port_, arg0),
...
class RustBackendPlatform extends FlutterRustBridgeBase<RustBackendWire> {
  RustBackendPlatform(ffi.DynamicLibrary dylib) : super(RustBackendWire(dylib));
...
class RustBackendWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  RustBackendWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  RustBackendWire.fromLookup(
